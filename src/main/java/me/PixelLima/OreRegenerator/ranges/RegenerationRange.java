...
public class RegenerationRange extends ProbabilityRange {
	
	private Material material;

	public RegenerationRange(String material, float minimum, float maximum) {
	...
	public Material getMaterial(Material currentMaterial) {
		...
		return material == null ? currentMaterial : material;
	}
}
